...
def insert_table(data, table) -> None:
    ...
    column_list = Collection.get_field_list_from_data_dict(data=data)
    ...
    query['start_date'] = data_collection.query_start_date(
        start_date_string=start_date)
    query['end_date'] = data_collection.query_end_date(
